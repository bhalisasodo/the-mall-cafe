export default function About() {
  return (
    <section id="about" className="bg-sand py-14 md:py-24">
      <div className="mx-auto grid max-w-6xl gap-6 sm:gap-10 px-5 md:grid-cols-[1fr_1.2fr] md:gap-16 md:px-8">
        <h2 className="font-display text-2xl sm:text-3xl font-extrabold leading-tight md:text-4xl">
          Verulam flavour, no shortcuts.
        </h2>
        <div className="space-y-4 sm:space-y-5 text-base sm:text-[1.05rem] leading-relaxed text-ink/85">
          <p>
